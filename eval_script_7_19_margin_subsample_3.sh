...
srun \
    ...
    python -m neural_lam.train_model \
        ...
        --load /iopsstor/scratch/cscs/sadamov/pyprojects_data/neural-lam/saved_models/train-hi_lam-2x300-02_12_16-1914/last.ckpt
        #--save_eval_to_zarr_path /iopsstor/scratch/cscs/sadamov/pyprojects_data/neural-lam/eval_results/preds_7_19_margin_subsample_3_era.zarr
