...
srun --container-writable \
    ...
    --config_path $SCRATCH/pyprojects_data/neural-lam/config_no_boundary.yaml \
    --model hi_lam \
    ...
    --load /iopsstor/scratch/cscs/sadamov/pyprojects_data/neural-lam/saved_models/train-hi_lam-2x300-02_10_15-9726/last.ckpt
